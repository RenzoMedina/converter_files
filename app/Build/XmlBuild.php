...
class XmlBuild implements BuildInterface{
    ...
    public function addMultiChoice($xml, $quiz, $p){
        // Crear pregunta
        $question = $xml->createElement('question');
        $question->setAttribute('type', 'multichoice');
    ...
    public function addEssay($xml, $quiz, $p){
    ...
    public function addTrueOrFalse($xml, $quiz, $p){
