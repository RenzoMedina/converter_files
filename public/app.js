...
if (url.has('success')) {
  const total = url.get('total'); // "12"
  showAlert(`¡Archivo horneado y servido! Descárgalo cuando quieras <br> Total de  ${total} preguntas creadas`, 7000, "rgba(4, 53, 7, 1)", "rgba(10, 151, 20, 0.39)")
}
